...
var indexLess = loadCSS( "/jqm/assets/build/css/index.css" );
onloadCSS( indexLess, function() {
	console.log( "index.css has loaded" );
});

// флаг, обозначающий, что первой страницей сайта была загружена главная страница
/*var flag = false;
...
if(!flag)
{
	$.getScript( "/jqm/assets/src/js/custom.js", function( data, textStatus, jqxhr ) {
		console.log( "custom.js loaded" );
	});
	$.getScript( "/jqm/dist/js/lazysizes.min.js", function( data, textStatus, jqxhr ) {
		console.log( "lazysizes.js loaded" );
	});
	$.getScript( "/jqm/dist/js/ls.unveilhooks.js", function( data, textStatus, jqxhr ) {
		console.log( "unveilhooks.js loaded" );
	});
